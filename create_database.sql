...
CREATE TABLE IF NOT EXISTS mensagens (id int NOT NULL AUTO_INCREMENT,autor varchar(255) NOT NULL,destinatario varchar(255) NOT NULL,mensagem varchar(4096) NOT NULL, PRIMARY KEY (id));
